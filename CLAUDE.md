...
**2clash** (config2clash) is a client-side proxy configuration converter built with Next.js. It transforms various proxy protocols (SS, SSR, Vmess, Trojan, Hysteria, VLESS, HTTP, SOCKS5) into Clash YAML format.
